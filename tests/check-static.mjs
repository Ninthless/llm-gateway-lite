...
assert.doesNotMatch(rainyunCompose, /LITELLM_REASONING_AUTO_SUMMARY/);
...
assert.doesNotMatch(config, /reasoning_auto_summary/);
assert.doesNotMatch(compose, /LITELLM_REASONING_AUTO_SUMMARY/);
